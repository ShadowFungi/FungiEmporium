...
var BotName = Username.Bot

var Oauth = OAuthToken.Token

var ChannelToJoin = Channel.ChannelJoined
...
func _ready() -> void:
	...
	authenticate_oauth(BotName, Oauth)
	...
	add_command("spores", self, "Spores")
...
func Spores(cmd_info : CommandInfo) -> void:
	...
	chat("Spores Released" + SporeCount.Spores)
