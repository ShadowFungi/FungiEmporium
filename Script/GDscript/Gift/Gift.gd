...
# warning-ignore:return_value_discarded
	authfile.open("res://auth", File.READ)
	
	var botname := "sporesbot"
	
	var token := "oauth:iag3a9xs1quodtz3dxwnhn4f2du2yt"

	
	var initial_channel = "ShadowFungi"
